  ...
  function loop() {
    ...
    VideoDecode.init()
      ...
      .then(function() {
        ...
        //        };
        //        console.log(format);
        //        Resize.setParameter(Resize.out_port, omx.INDEXTYPE.IndexParamPortDefinition, format);

        //        var format2 = {
        //          eMode: omx.RESIZEMODETYPE.RESIZE_CROP,
        //          nMaxWidth: rw,
        //          nMaxHeight: rh,
        ...
        //        Resize.setParameter(Resize.out_port, omx.INDEXTYPE.IndexParamResize, format2);
