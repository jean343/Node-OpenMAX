...
//      console.log('rendererPortDefinition', rendererPortDefinition);
//      console.log('portDefinitionChanged', self.name, self.component.in_port, self.component.getState(), portDefinition);
...
Component.prototype._read = function () {
  ...
  console.log('done fillBuffer', self.name);
  ...
  console.log('done _read', this.name);
};
...
//  if (this.name === 'video_render')
  ...
  this.component.emptyBuffer(inputBuffer, function () {
    console.log('emptyBuffer', self.name);
    if (self.name === 'video_render')
      console.log('emptyBuffer', true);
  });
    setTimeout(next, 0);
//    setTimeout(next, 10);
    console.log('done _write', this.name);
};
