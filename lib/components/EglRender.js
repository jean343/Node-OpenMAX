...
function EglRender() {
  if (!(this instanceof EglRender)) {
    return new EglRender();
  }
  Component.call(this, 'egl_render'); // call parent constructor
  ...
  self.on('finish', function () {
    console.log('EglRender on finish');
...
util.inherits(EglRender, Component);



module.exports = EglRender;
