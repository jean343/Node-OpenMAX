...
function VideoSplitter() {
  if (!(this instanceof VideoSplitter)) {
    return new VideoSplitter();
  }
  Component.call(this, 'video_splitter'); // call parent constructor
  ...
  self.on('finish', function () {
    console.log('VideoSplitter on finish');
...
util.inherits(VideoSplitter, Component);
